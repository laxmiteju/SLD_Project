  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-8 max-w-2xl mx-auto">
        <h1 className="text-xl font-semibold text-[#0F2444] mb-6">Generate an NOC</h1>
        ...
        {loading ? (
          ...
          <div className="bg-white border rounded-lg shadow-sm p-6 space-y-5">
            ...
            <button
              ...
              onClick={() => router.push(`/noc/new?flat_id=${selectedFlatId}`)}
...
export default function NocSelectorPage() {
  return (
    <RequireAuth>
      <SelectorContent />
    </RequireAuth>

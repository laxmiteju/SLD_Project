  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-8 max-w-2xl mx-auto">
        <h1 className="text-xl font-semibold text-[#0F2444] mb-6">Generate a Cost Sheet</h1>
        ...
        {loading ? (
          ...
          <div className="bg-white border rounded-lg shadow-sm p-6 space-y-5">
              ...
              >
                ...
                {flats.map((f) => (
                  <option key={f.id} value={f.id}>
                    {f.block ? `Block ${f.block} - ` : ''}{f.flat_no} ({f.floor}, {f.facing})
                  </option>
                ))}
              </select>
            </div>
            ...
            <button
              ...
              className="bg-[#1F3864] text-white px-5 py-2.5 rounded-md disabled:bg-gray-300 disabled:cursor-not-allowed hover:bg-[#16294B] transition-colors font-medium w-full sm:w-auto"
            >
              Generate Cost Sheet
            </button>
          </div>
